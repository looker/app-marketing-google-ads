- dashboard: campaign_metrics_spend
  ...
  - title: Ad Spend Change
    ...
    fields: [campaign.name, ad_group.ad_group_name, ad.creative, fact.total_cost,
      last_fact.total_cost, fact.total_cost_period_delta]
    filters:
  ...
  - title: Landing Page Spend Change
    ...
    fields: [campaign.name, ad_group.ad_group_name, ad.creative_final_urls_domain_path,
      fact.total_cost, last_fact.total_cost, fact.total_cost_period_delta]
    filters:
      fact.total_cost_period_delta_abs: ">0"
    sorts: [fact.total_cost_period_delta_abs desc]
    limit: 50
  ...
  - title: Spend by Day of Week and Hour of Day
    ...
    conditional_formatting: [{type: along a scale..., value: !!null '', background_color: !!null '',
        font_color: !!null '', palette: {name: Red to Yellow to Green, colors: ["#F36254",
            "#FCF758", "#4FBC89"]}, bold: false, italic: false, strikethrough: false,
        fields: [fact.total_cost], color_application: {collection_id: legacy, custom: {
            id: 7a515274-1c3f-6fac-734f-ca2a596b5e6c, label: Custom, type: continuous,
